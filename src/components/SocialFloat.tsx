...
const SOCIALS = [
  { icon: Instagram, href: "https://www.instagram.com/academiaflipper", bg: "bg-gradient-to-br from-[hsl(340,75%,55%)] to-[hsl(30,90%,55%)]", label: "Instagram" },
  { icon: Facebook, href: "https://www.facebook.com/academiaflipper", bg: "bg-[hsl(221,44%,41%)]", label: "Facebook" },
  { icon: Youtube, href: "https://www.youtube.com/@academiaflipper", bg: "bg-[hsl(0,100%,42%)]", label: "YouTube" },
  { icon: Linkedin, href: "https://www.linkedin.com/company/academiaflipper", bg: "bg-[hsl(201,100%,35%)]", label: "LinkedIn" },
  {
    icon: Phone,
