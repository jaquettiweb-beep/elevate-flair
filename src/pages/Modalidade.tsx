...
// ─── Yoga (enviadas pelo usuário com legenda "yoga") ──────────────────────────
...
// ─── Judô (enviadas pelo usuário com legenda "em judo") ───────────────────────
...
import judo7 from "@/assets/judo-7.jpg";
import judo8 from "@/assets/judo-8.jpg";
import judo9 from "@/assets/judo-9.jpg";
import judo10 from "@/assets/judo-10.jpg";
import judo11 from "@/assets/judo-11.jpg";
import judo12 from "@/assets/judo-12.jpg";
import judo13 from "@/assets/judo-13.jpg";
import judo14 from "@/assets/judo-14.jpg";

// ─── Jiu Jitsu (enviadas pelo usuário com legenda "em jiu jitsu") ─────────────
...
import jiujitsu7 from "@/assets/jiujitsu-7.jpg";
import jiujitsu8 from "@/assets/jiujitsu-8.jpg";
import jiujitsu9 from "@/assets/jiujitsu-9.jpg";
import jiujitsu10 from "@/assets/jiujitsu-10.jpg";

// ─── Aikidô (enviadas pelo usuário com legenda "para aikido") ─────────────────
...
import aikido7 from "@/assets/aikido-7.jpg";
import aikido8 from "@/assets/aikido-8.jpg";
import aikido9 from "@/assets/aikido-9.jpg";
import aikido10 from "@/assets/aikido-10.jpg";
import aikido11 from "@/assets/aikido-11.jpg";
import aikido12 from "@/assets/aikido-12.jpg";

// ─── Ballet real (enviadas pelo usuário) ──────────────────────────────────────
...
// ─── Ginástica (enviadas pelo usuário com legenda "para ginastica") ───────────
...
// ─── 60+ (enviadas pelo usuário com legenda "no 60+ use") ────────────────────
// O usuário mandou com legenda "no 60+ use:", usamos yoga-real como principal
// e complementamos com yoga_new
...
const MODALITY_DATA: Record<string, ModalityData> = {
  ...
  "muay-thai": {
    name: "Muay Thai",
    slug: "muay-thai",
    galleryImgs: [jiujitsu1, jiujitsu2, jiujitsu3, jiujitsu4, jiujitsu5, jiujitsu6, jiujitsu7, jiujitsu8, jiujitsu9, jiujitsu10],
    emoji: "🥊",
    description:
  ...
  "judo-infantil": {
    name: "Judô (Infantil)",
    slug: "judo-infantil",
    galleryImgs: [judo1, judo2, judo3, judo4, judo5, judo6, judo7, judo8, judo9, judo10, judo11, judo12, judo13, judo14],
    emoji: "🥋",
    description:
  ...
  "krav-maga": {
    name: "Krav Maga",
    slug: "krav-maga",
    galleryImgs: [aikido1, aikido2, aikido3, aikido4, aikido5, aikido6, aikido7, aikido8, aikido9, aikido10, aikido11, aikido12],
    emoji: "🛡️",
    description:
